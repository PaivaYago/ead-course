...
public class ModuleServiceImpl implements ModuleService {
    ...
    public Optional<ModuleModel> findModuleIntoCourse(UUID courseId, UUID moduleId) {
        Optional<ModuleModel> moduleModel = moduleRepository.findModuleIntoCourse(courseId, moduleId);
    ...
    @Override
    public ModuleModel updateModule(ModuleRecordDto moduleRecordDto, ModuleModel moduleModel) {
        BeanUtils.copyProperties(moduleRecordDto, moduleModel);
        return moduleRepository.save(moduleModel);
    }
