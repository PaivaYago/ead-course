...
public class AuthUserClient {
    ...
    public Page<UserRecordDto> getAllUsersByCourse(UUID courseId, Pageable pageable) {
        String url = baseUrlUser + "/users?courseId=" + courseId + "&page=" + pageable.getPageNumber() + "&size="
    ...
    public ResponseEntity<UserRecordDto> getOneUserById(UUID userId){
        String url = baseUrlUser + "/users/" + userId;
        logger.debug("Request URL: {} ", url);
    ...
    public void postSubscriptionUserInCourse(UUID courseId, UUID userId){
        String url = baseUrlUser + "/users/" + userId + "/courses/subscription";
        logger.debug("Request URL: {} ", url);
    ...
    public void deleteCourseUserInAuthUser(UUID courseId){
        String url = baseUrlUser + "/users/courses/" + courseId ;
        logger.debug("Request URL: {} ", url);
