...
import com.ead.course.utils.SpecUtils;
...
public class ModuleController {
    ...
    public ResponseEntity<Page<ModuleModel>> getAllModules(@PathVariable(value = "courseId") UUID courseId,
        ...
        return ResponseEntity.status(HttpStatus.OK).body(moduleService
                .findAllModulesIntoCourse(SpecUtils.safeAnd(SpecificationTemplate.moduleCourseId(courseId), spec), pageable));
    }
    ...
    public ResponseEntity<Object> updateModule(@PathVariable(value = "courseId") UUID courseId,
        ...
        return ResponseEntity.status(HttpStatus.OK).
                body(moduleService.updateModule(moduleRecordDto, moduleService.findModuleIntoCourse(courseId, moduleId).get()));
    }
}
